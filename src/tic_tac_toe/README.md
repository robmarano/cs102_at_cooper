# Tic Tac Toe
## according to Prof Sable

# Requirements
1. Have a tic-tac-toe board
2. Allow a user to choose to play first or second
3. Have a computer player to choose logical moves
4. Determine the win/lose/tie conditions
5. Ask a player if they want to play again
6. Exit game program
...
[Link to full tic-tac-toe.c source code in C](./tic-tac-toe.c).
